...
**Seleccione idioma:** [Español](GUIA_INSTALACION.md) · [English](INSTALL_GUIDE.md)
...
> 🌐 **¿Solo quieres probarlo?** No hace falta instalar nada: la demo está en línea en
> **https://migra-ia.onrender.com** — si el servicio está dormido, la primera carga tarda cerca de un minuto.
...
## ✅ Paso 3 — Instalar el agente (una sola vez)
...
## ✅ Paso 4 — Ejecutar y probar GRATIS (demo interactiva)
...
## 🔑 Paso 5 (opcional) — Usar el agente real con IA
...
| El `.bat` se abre y se cierra de inmediato | Primero completa el **Paso 3** (crear `.venv` e instalar). El lanzador necesita el entorno ya instalado. |
