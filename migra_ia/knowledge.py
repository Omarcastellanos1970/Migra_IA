...
def query(tema: str, key=None) -> dict:
    ...
    despacho = {
        ...
        "principles": lambda: {"guiding_principles": base["guiding_principles"]},
        "deliverables": lambda: {"minimum_deliverables": base["minimum_deliverables"],
        ...
        "manufacturer_matrix": lambda: {"verification_matrix": base["manufacturers"]["verification_matrix"]},
        ...
        "annex": lambda: _find_annex(base, key),
