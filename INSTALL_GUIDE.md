...
> 🌐 **Just want to try it?** There is nothing to install: the demo is online at
> **https://migra-ia.onrender.com** — if the service is asleep, the first load takes about a minute.
...
## ✅ Step 3 — Install the agent (once only)
...
## ✅ Step 4 — Run it and try it FREE (interactive demo)
...
## 🔑 Step 5 (optional) — Use the real agent with AI
...
| The `.bat` opens and closes immediately | Complete **Step 3** first (create `.venv` and install). The launcher needs the environment already installed. |
