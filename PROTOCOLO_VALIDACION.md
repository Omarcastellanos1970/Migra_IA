...
**Se abre una sola vez**, con el protocolo ya cerrado, y **lo que salga es lo
que se publica**. No se vuelve a ajustar nada después de abrirlo: si el
resultado obliga a cambiar el modelo, ese cambio empieza un protocolo nuevo y el
