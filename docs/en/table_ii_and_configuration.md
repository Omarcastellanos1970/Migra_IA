...
|---|---|---|---|
| **Trivial**<br><sub>majority class of the training fold</sub> | 0.402 ± 0.038 | 0.675 | 0.024 |
...
| Admitted feature | antiguedad = 2026 - Lanzamiento | leakage audit: the only survivor | yes |
...
| Cost, trivial | 0.024 us/case | best of 9 rounds x 2000 repetitions; dispersion 0.003 us (11 % of the value), which is why the table carries two significant figures | yes |
| Cost, classic | 0.536 us/case | best of 9 rounds x 2000 repetitions; dispersion 0.031 us (6 % of the value), which is why the table carries two significant figures | yes |
...
| Training time | 67 ms | measured here: training the complete cross-validation, best of 5 rounds | yes |
