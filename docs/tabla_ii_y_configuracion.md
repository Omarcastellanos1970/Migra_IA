...
|---|---|---|---|
| **Trivial**<br><sub>clase mayoritaria del pliegue de entrenamiento</sub> | 0,402 ± 0,038 | 0,675 | 0,026 |
...
| Caracteristica admitida | antiguedad = 2026 - release | auditoria de fuga: unica superviviente | sí |
...
| Coste, trivial | 0.026 us/caso | mejor de 9 rondas x 2000 repeticiones; dispersion 0.021 us (82 % del valor), por eso la tabla lleva dos cifras significativas | **NO** |
| Coste, clasico | 0.536 us/caso | mejor de 9 rondas x 2000 repeticiones; dispersion 0.047 us (9 % del valor), por eso la tabla lleva dos cifras significativas | sí |
...
| Tiempo de entrenamiento | 66 ms | medido aqui: entrenar la validacion cruzada completa, mejor de 5 rondas | sí |
